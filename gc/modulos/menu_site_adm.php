...
switch($_REQUEST['acao'])
{
	...
	case 'inserido':
		...
		$o_menu_site->set('chamada_menu', str_replace(" ", "_", $chamada_nome));
...
switch($_REQUEST['layout'])
{
	...
	case 'form': 
		...
		<strong>Nome</strong>
		<input name="_nome" id="_nome" type="text" maxlength="150" value="<?=$l['nome']?>" size="60" onblur="javascript:valida_nome(this.value, '<?=$l['nome']?>', 'menu');"/>
