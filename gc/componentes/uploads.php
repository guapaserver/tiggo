...
class qqFileUploader {
	...
	function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
		...
		if ($this->file->save($uploadDirectory . $filename. '.' . $ext)){
			...
			$o_resize_img = new Resize_img;
			//$o_resize_img->set('altura', '80');
			$o_resize_img->set('largura', '213');
			$o_resize_img->set('ruta_imagem', '../../imagens/galeria_thumbnail/');
			$o_resize_img->set('nome_imagem', $filename);
			$o_resize_img->resize_imagem();
	...
	function carateres_especiais($nome){
	  ...
	  $n_n = str_replace("�","a",$n_n);
	  $n_n = str_replace("�","e",$n_n);
	  $n_n = str_replace("�","i",$n_n);
	  $n_n = str_replace("�","o",$n_n);
	  $n_n = str_replace("�","u",$n_n);
	  $n_n = str_replace("�","c",$n_n);
	  $n_n = str_replace("�","a",$n_n);
	  $n_n = str_replace("�","a",$n_n);
	  $n_n = str_replace("�","o",$n_n);
	  $n_n = str_replace("!","",$n_n);
