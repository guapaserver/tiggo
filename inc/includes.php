...
if($_SERVER['SERVER_NAME'] == "localhost" || $_SERVER['SERVER_NAME'] == "127.0.0.1" || $_SERVER['SERVER_NAME'] == "10.0.1.252")
{
	$c = "/Applications/XAMPP/xamppfiles/htdocs/tiggo/";
}
else
{
	//$c = "/home/krakendigital/public_html/clientes/oportunidade/";
	$c = "/var/www/vhosts/agenciaguapa.com.br/httpdocs/clientes/guapa/";
}


//$c = "/Applications/XAMPP/xamppfiles/htdocs/guapa/";
//$c = "/var/www/vhosts/agenciaguapa.com.br/httpdocs/clientes/guapa/";
//****
