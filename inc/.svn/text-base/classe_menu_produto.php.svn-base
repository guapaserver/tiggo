		...
		if($rs)
		{
			...
			foreach($rs as $linha)
			{
				...
				{	
					...
					{
						$menu .= "<li >".$primeiro_li."<a class=\"filtro_menu ".$class."\" href=\"".$url_virtual."materia/".$linha['chamada_categoria'].$test_css."\" data-option-value=\"".$data_option_value."\" >".strtoupper($linha['nome'])."</a></li>";
					}
				}
			$x ++;
			}
