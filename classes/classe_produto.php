...
class Produto extends Executa
{
	...
	private $estado;
	private $ordem;
	private $logo_imagem_02;
	private $estilo_retrato;
	private $id_album;
	private $logo_imagem;
	private $nome_imagem;
	private $nome_imagem_blur;
	private $url_video;
	...
	public function selecionar()
	{
		...
		$q .= !empty($this->logo_imagem_02) ? "AND logo_imagem_02 = '".$this->logo_imagem_02."' " : " ";
		$q .= !empty($this->estilo_retrato) ? "AND estilo_retrato = '".$this->estilo_retrato."' " : " ";
		$q .= !empty($this->id_album) ? "AND id_album = '".$this->id_album."' " : " ";
		$q .= !empty($this->logo_imagem) ? "AND logo_imagem = '".$this->logo_imagem."' " : " ";
		$q .= !empty($this->nome_imagem) ? "AND nome_imagem = '".$this->nome_imagem."' " : " ";
		$q .= !empty($this->url_video) ? "AND url_video = '".$this->url_video."' " : " ";
		$q .= !empty($this->url_video) ? "AND url_video = '".$this->url_video."' " : " ";
...
//die($q);
	...
	public function selecionar_produto_complemento()
	{
		...
		,".$this->prefixo."_tbl_produto.logo_imagem
		,".$this->prefixo."_tbl_produto.nome_imagem
		,".$this->prefixo."_tbl_produto.nome_imagem_blur
		,".$this->prefixo."_tbl_produto.url_video
		,".$this->prefixo."_tbl_produto.logo_imagem_02
		...
		,(SELECT abc.nome FROM  ".$this->prefixo."_tbl_produto_tipo abc
			INNER JOIN ".$this->prefixo."_tbl_produto_tipo 
			ON ".$this->prefixo."_tbl_produto_tipo.id = abc.id
			WHERE ".$this->prefixo."_tbl_produto_tipo.id = ".$this->prefixo."_tbl_produto.id_produto_tipo limit 0,1) AS produto_tipo
		...
		$q .= !empty($this->logo_imagem) ? "AND ".$this->prefixo."_tbl_produto.logo_imagem = '".$this->logo_imagem."' " : " ";
		$q .= !empty($this->nome_imagem) ? "AND ".$this->prefixo."_tbl_produto.nome_imagem = '".$this->nome_imagem."' " : " ";
		$q .= !empty($this->url_video) ? "AND ".$this->prefixo."_tbl_produto.url_video = '".$this->url_video."' " : " ";
		$q .= !empty($this->logo_imagem_02) ? "AND ".$this->prefixo."_tbl_produto.logo_imagem_02 = '".$this->logo_imagem_02."' " : " ";
	...
	public function editar_album()
	{
		...
		$q .= !empty($this->logo_imagem) ? " logo_imagem = '".$this->logo_imagem."' " : " ";
		$q .= !empty($this->nome_imagem) ? " nome_imagem = '".$this->nome_imagem."' " : " ";
		$q .= !empty($this->url_video) ? " url_video = '".$this->url_video."' " : " ";
