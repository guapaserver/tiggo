...
class Usuario extends Executa
{
	...
	public function selecionar()
	{
		...
		$q .= !empty($this->chamada_usuario) ? "AND chamada_usuario = '".$this->chamada_usuario."' " : " ";
...
//die($q);
	...
	public function selecionar_usuario_pessoa()
	{
		...
		".$this->prefixo."_tbl_usuario.cidade,
		".$this->prefixo."_tbl_usuario.uf,
	...
	public function selecionar_usuario_complemento()
	{
		$q = "
		...
		".$this->prefixo."_tbl_usuario.id 
		,".$this->prefixo."_tbl_usuario.nome 
		,".$this->prefixo."_tbl_usuario.descricao
		,".$this->prefixo."_tbl_usuario.ordem
		,".$this->prefixo."_tbl_usuario.usuario_foto
		,".$this->prefixo."_tbl_usuario.chamada_usuario
		";
		...
		$q .= !empty($this->termo_busca) ? "AND (".$this->prefixo."_tbl_usuario.nome LIKE '%".$this->termo_busca."%' OR corpo LIKE '%".$this->termo_busca."%' OR palavra_chave LIKE '%".$this->termo_busca."%')": " ";
		$q .= !empty($this->nome) ? "AND ".$this->prefixo."_tbl_usuario.nome = '".$this->nome."' " : " ";
		$q .= !empty($this->corpo) ? "AND corpo = '".$this->corpo."' " : " ";
		$q .= !empty($this->id) ? "AND ".$this->prefixo."_tbl_usuario.id = '".$this->id."' " : " ";
		$q .= !empty($this->estado) ? "AND ".$this->prefixo."_tbl_usuario.estado = '".$this->estado."' " : " ";
		$q .= !empty($this->ordem) ? "AND ".$this->prefixo."_tbl_usuario.ordem = '".$this->ordem."' " : " ";
		$q .= !empty($this->chamada_produto) ? "AND ".$this->prefixo."_tbl_usuario.chamada_produto = '".$this->chamada_produto."' " : " ";
		$q .= !empty($this->id_usuario_tipo) ? "AND ".$this->prefixo."_tbl_usuario.id_usuario_tipo = '".$this->id_usuario_tipo."' " : " ";
		$q .= !empty($this->in_busca) ? " AND ".$this->prefixo."_tbl_usuario.id IN (".$this->in_busca.") " : " ";
	...
	public function editar()
	{
		...
		$q .= !empty($this->chamada_usuario) ? ", chamada_usuario = '".$this->chamada_usuario."' " : " "; 
