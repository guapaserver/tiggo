...
class Produto_tipo extends Executa
{
	private $id;
	private $nome; 
	...
	public function selecionar()
	{
		...
		$q .= "FROM ".$this->prefixo."_tbl_produto_tipo 
		WHERE 
		1=1  
		";
	...
	public function inserir()
	{
		...
		INSERT INTO ".$this->prefixo."_tbl_produto_tipo
		(
	...
	public function editar()
	{
		...
		UPDATE ".$this->prefixo."_tbl_produto_tipo SET 
	...
	public function excluir()
	{
		...
		DELETE FROM ".$this->prefixo."_tbl_produto_tipo WHERE id='".$this->id."'";
	...
	public function ultimo_id()
	{
		...
		SELECT LAST_INSERT_ID(id) AS id  FROM ".$this->prefixo."_tbl_produto_tipo ORDER BY id DESC LIMIT 1
